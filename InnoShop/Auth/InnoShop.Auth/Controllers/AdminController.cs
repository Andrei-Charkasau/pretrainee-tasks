...
namespace InnoShop.Auth.Controllers
{
    ...
    public class AdminController : ControllerBase
    {
        ...
        private int GetCurrentAdminId() => int.Parse(User.FindFirst(ClaimTypes.NameIdentifier)?.Value); //Логирую Айди Админа, который де/активировал юзера| прятал/показывал продукт (чтобы видеть кто и когда)
